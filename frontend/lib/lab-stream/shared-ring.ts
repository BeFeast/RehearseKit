import { CTRL, STATE, type RingLayout } from './ring-layout';

/**
 * Main-thread view of the shared control block and ring buffers. The
 * AudioWorklet processor (public/lab/stream-processor.js) is the consumer.
 */
